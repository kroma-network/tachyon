...
[[nodiscard]] bool PermuteExpressionPair(ProverBase<PCS>* prover,
  ...
  std::vector<F, base::memory::ReusingAllocator<F>> permuted_input_expressions =
      in.input().evaluations();
  ...
  std::vector<F, base::memory::ReusingAllocator<F>> permuted_table_expressions(
      domain_size);
