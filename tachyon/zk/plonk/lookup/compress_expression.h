...
#ifndef TACHYON_ZK_PLONK_LOOKUP_COMPRESS_EXPRESSION_H_
#define TACHYON_ZK_PLONK_LOOKUP_COMPRESS_EXPRESSION_H_
...
#endif  // TACHYON_ZK_PLONK_LOOKUP_COMPRESS_EXPRESSION_H_
