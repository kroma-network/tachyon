...
TEST_F(Fibonacci3V1CircuitTest, Configure) {
  ...
  EXPECT_EQ(fibonacci3_v1::kPinnedConstraintSystem,
...
TEST_F(Fibonacci3V1CircuitTest, LoadVerifyingKey) {
  ...
  EXPECT_EQ(fibonacci3_v1::kPinnedVerifyingKey,
...
TEST_F(Fibonacci3V1CircuitTest, CreateProof) {
  ...
  std::vector<uint8_t> expected_proof(std::begin(fibonacci3_v1::kExpectedProof),
                                      std::end(fibonacci3_v1::kExpectedProof));
...
TEST_F(Fibonacci3V1CircuitTest, VerifyProof) {
  ...
  std::vector<uint8_t> owned_proof(std::begin(fibonacci3_v1::kExpectedProof),
                                   std::end(fibonacci3_v1::kExpectedProof));
