...
#ifndef TACHYON_ZK_PLONK_CIRCUIT_SELECTOR_ASSIGNMENT_H_
#define TACHYON_ZK_PLONK_CIRCUIT_SELECTOR_ASSIGNMENT_H_
...
#endif  // TACHYON_ZK_PLONK_CIRCUIT_SELECTOR_ASSIGNMENT_H_
