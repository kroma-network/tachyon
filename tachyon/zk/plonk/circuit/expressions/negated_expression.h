...
#ifndef TACHYON_ZK_PLONK_CIRCUIT_EXPRESSIONS_NEGATED_EXPRESSION_H_
#define TACHYON_ZK_PLONK_CIRCUIT_EXPRESSIONS_NEGATED_EXPRESSION_H_
...
#endif  // TACHYON_ZK_PLONK_CIRCUIT_EXPRESSIONS_NEGATED_EXPRESSION_H_
