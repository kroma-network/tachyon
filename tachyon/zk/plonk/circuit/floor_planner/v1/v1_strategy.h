...
#ifndef TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_V1_V1_STRATEGY_H_
#define TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_V1_V1_STRATEGY_H_
...
SlotInBiggestAdviceFirstResult SlotInBiggestAdviceFirst(
  ...
  // NOTE(TomTaehoonKim): Sorted result might be different from the original
  // See
  // https://github.com/kroma-network/halo2/blob/7d0a36990452c8e7ebd600de258420781a9b7917/halo2_proofs/src/circuit/floor_planner/v1/strategy.rs#L202-L215
...
#endif  // TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_V1_V1_STRATEGY_H_
