...
#ifndef TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_SCOPED_REGION_H_
#define TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_SCOPED_REGION_H_
...
#endif  // TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_SCOPED_REGION_H_
