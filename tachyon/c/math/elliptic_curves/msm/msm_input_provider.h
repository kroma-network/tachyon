...
class MSMInputProvider {
 public:
  ...
  absl::Span<const tachyon::math::bn254::G1AffinePoint> bases() const {
    return bases_;
  }
  absl::Span<const tachyon::math::bn254::Fr> scalars() const {
    return scalars_;
  }
 ...
 private:
  ...
  absl::Span<const tachyon::math::bn254::G1AffinePoint> bases_;
  absl::Span<const tachyon::math::bn254::Fr> scalars_;
  std::vector<tachyon::math::bn254::G1AffinePoint> bases_owned_;
  std::vector<tachyon::math::bn254::Fr> scalars_owned_;
};
