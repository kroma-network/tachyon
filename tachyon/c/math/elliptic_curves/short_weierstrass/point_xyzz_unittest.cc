...
class PointXYZZTest : public testing::Test {
 public:
  void SetUp() override {
    ...
    g1_c_a_ = c::math::ToCPointXYZZ(g1_a_);
    g1_c_b_ = c::math::ToCPointXYZZ(g1_b_);

    g2_a_ = math::bn254::G2PointXYZZ::Random();
    g2_b_ = math::bn254::G2PointXYZZ::Random();
    g2_c_a_ = c::math::ToCPointXYZZ(g2_a_);
    g2_c_b_ = c::math::ToCPointXYZZ(g2_b_);
  }
...
TEST_F(PointXYZZTest, Zero) {
  ...
  EXPECT_TRUE(c::math::ToPointXYZZ(c_ret2).IsZero());
}
...
TEST_F(PointXYZZTest, Add) {
  ...
  EXPECT_EQ(c::math::ToPointXYZZ(c_ret), g1_a_ + g1_b_);
  ...
  EXPECT_EQ(c::math::ToPointXYZZ(c_ret), g1_a_ + d);

  tachyon_bn254_g2_xyzz c_ret2 = tachyon_bn254_g2_xyzz_add(&g2_c_a_, &g2_c_b_);
  EXPECT_EQ(c::math::ToPointXYZZ(c_ret2), g2_a_ + g2_b_);
  ...
  EXPECT_EQ(c::math::ToPointXYZZ(c_ret2), g2_a_ + d2);
}
