...
class AffinePointTest : public testing::Test {
 public:
  void SetUp() override {
    ...
    g1_c_a_ = c::math::ToCAffinePoint(g1_a_);
    g1_c_b_ = c::math::ToCAffinePoint(g1_b_);

    g2_a_ = math::bn254::G2AffinePoint::Random();
    g2_b_ = math::bn254::G2AffinePoint::Random();
    g2_c_a_ = c::math::ToCAffinePoint(g2_a_);
    g2_c_b_ = c::math::ToCAffinePoint(g2_b_);
  }
...
TEST_F(AffinePointTest, Zero) {
  ...
  EXPECT_TRUE(c::math::ToAffinePoint(c_ret2).IsZero());
}
...
TEST_F(AffinePointTest, Generator) {
  ...
  EXPECT_EQ(c::math::ToAffinePoint(c_ret2),
...
TEST_F(AffinePointTest, Random) {
  ...
  EXPECT_NE(c::math::ToAffinePoint(c_ret), g1_a_);

  tachyon_bn254_g2_affine c_ret2 = tachyon_bn254_g2_affine_random();
  EXPECT_NE(c::math::ToAffinePoint(c_ret2), g2_a_);
}
...
TEST_F(AffinePointTest, Neg) {
  ...
  EXPECT_EQ(c::math::ToAffinePoint(c_ret), -g1_a_);

  tachyon_bn254_g2_affine c_ret2 = tachyon_bn254_g2_affine_neg(&g2_c_a_);
  EXPECT_EQ(c::math::ToAffinePoint(c_ret2), -g2_a_);
}
