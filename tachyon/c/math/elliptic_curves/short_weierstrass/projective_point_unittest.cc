...
class ProjectivePointTest : public testing::Test {
 public:
  void SetUp() override {
    ...
    g1_c_a_ = c::math::ToCProjectivePoint(g1_a_);
    g1_c_b_ = c::math::ToCProjectivePoint(g1_b_);

    g2_a_ = math::bn254::G2ProjectivePoint::Random();
    g2_b_ = math::bn254::G2ProjectivePoint::Random();
    g2_c_a_ = c::math::ToCProjectivePoint(g2_a_);
    g2_c_b_ = c::math::ToCProjectivePoint(g2_b_);
  }
...
TEST_F(ProjectivePointTest, Random) {
  ...
  EXPECT_NE(c::math::ToProjectivePoint(c_ret), g1_a_);

  tachyon_bn254_g2_projective c_ret2 = tachyon_bn254_g2_projective_random();
  EXPECT_NE(c::math::ToProjectivePoint(c_ret2), g2_a_);
}
...
TEST_F(ProjectivePointTest, Add) {
  ...
  EXPECT_EQ(c::math::ToProjectivePoint(c_ret), g1_a_ + g1_b_);
  ...
  EXPECT_EQ(c::math::ToProjectivePoint(c_ret), g1_a_ + d);

  tachyon_bn254_g2_projective c_ret2 =
      tachyon_bn254_g2_projective_add(&g2_c_a_, &g2_c_b_);
  EXPECT_EQ(c::math::ToProjectivePoint(c_ret2), g2_a_ + g2_b_);

  math::bn254::G2AffinePoint d2 = math::bn254::G2AffinePoint::Random();
  tachyon_bn254_g2_affine c_d2 = c::math::ToCAffinePoint(d2);
  c_ret2 = tachyon_bn254_g2_projective_add_mixed(&g2_c_a_, &c_d2);
  EXPECT_EQ(c::math::ToProjectivePoint(c_ret2), g2_a_ + d2);
}
...
TEST_F(ProjectivePointTest, Neg) {
  ...
  EXPECT_EQ(c::math::ToProjectivePoint(c_ret), -g1_a_);

  tachyon_bn254_g2_projective c_ret2 =
      tachyon_bn254_g2_projective_neg(&g2_c_a_);
  EXPECT_EQ(c::math::ToProjectivePoint(c_ret2), -g2_a_);
}

TEST_F(ProjectivePointTest, Dbl) {
  tachyon_bn254_g1_projective c_ret = tachyon_bn254_g1_projective_dbl(&g1_c_a_);
  EXPECT_EQ(c::math::ToProjectivePoint(c_ret), g1_a_.Double());

  tachyon_bn254_g2_projective c_ret2 =
      tachyon_bn254_g2_projective_dbl(&g2_c_a_);
  EXPECT_EQ(c::math::ToProjectivePoint(c_ret2), g2_a_.Double());
}
