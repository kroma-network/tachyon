...
class PrimeFieldTest : public testing::Test {
 public:
  void SetUp() override {
    ...
    c_a_ = cc::math::c_cast(a_);
    c_b_ = cc::math::c_cast(b_);
  }
