...
tachyon_halo2_bn254_transcript_writer_create(uint8_t type) {
  ...
  if (type == TACHYON_HALO2_BLAKE_TRANSCRIPT) {
    ...
    zk::halo2::Blake2bWriter<math::bn254::G1AffinePoint>* blake2b =
        new zk::halo2::Blake2bWriter<math::bn254::G1AffinePoint>(
            std::move(write_buf));
...
void tachyon_halo2_bn254_transcript_writer_destroy(
  ...
  if (writer->type == TACHYON_HALO2_BLAKE_TRANSCRIPT) {
    zk::halo2::Blake2bWriter<math::bn254::G1AffinePoint>* blake2b =
        reinterpret_cast<zk::halo2::Blake2bWriter<math::bn254::G1AffinePoint>*>(
            writer->extra);
    delete blake2b;
  }
  delete writer;
