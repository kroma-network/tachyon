/**
 * @file
 * @brief Interface for the Halo2 BN254 GWC Prover.
 *
 * This header file defines the structure and API for the GWC prover specific to
 ...
 * proofs.
 */
#ifndef TACHYON_C_ZK_PLONK_HALO2_BN254_GWC_PROVER_H_
#define TACHYON_C_ZK_PLONK_HALO2_BN254_GWC_PROVER_H_
...
/**
 * @struct tachyon_halo2_bn254_gwc_prover
 * @brief Structure representing a GWC prover for the Halo2 protocol over BN254.
 *
 * Encapsulates the state and functionality required for constructing Halo2
 * proofs using the GWC construction on the BN254 curve. This includes managing
...
/**
 * @brief Creates a GWC prover from unsafe setup parameters.
 *
...
/**
 * @brief Creates a GWC prover from given parameters.
 *
...
tachyon_halo2_bn254_gwc_prover_commit(
    const tachyon_halo2_bn254_gwc_prover* prover,
 ...
 */
TACHYON_C_EXPORT void tachyon_halo2_bn254_gwc_prover_batch_start(
    tachyon_halo2_bn254_gwc_prover* prover, size_t len);

/**
 * @brief Commits to a polynomial using the prover.
 *
 * Unlike \ref tachyon_halo2_bn254_gwc_prover_commit(), this function doesn't
 ...
 */
TACHYON_C_EXPORT void tachyon_halo2_bn254_gwc_prover_batch_commit(
    tachyon_halo2_bn254_gwc_prover* prover,
 ...
 * @brief Commits to polynomial evaluations (Lagrange form) using the prover.
 *
 * Unlike \ref tachyon_halo2_bn254_gwc_prover_commit_lagrange(),
 ...
 * @param idx The index of the commitment.
 */
TACHYON_C_EXPORT void tachyon_halo2_bn254_gwc_prover_batch_commit_lagrange(
    tachyon_halo2_bn254_gwc_prover* prover,
 ...
 * @param len The number of commitments.
 */
TACHYON_C_EXPORT void tachyon_halo2_bn254_gwc_prover_batch_end(
    tachyon_halo2_bn254_gwc_prover* prover, tachyon_bn254_g1_affine* points,
    size_t len);
...
#endif  // TACHYON_C_ZK_PLONK_HALO2_BN254_GWC_PROVER_H_
