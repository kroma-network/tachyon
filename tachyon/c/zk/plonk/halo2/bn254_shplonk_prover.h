 ...
 */
TACHYON_C_EXPORT void tachyon_halo2_bn254_shplonk_prover_batch_start(
    tachyon_halo2_bn254_shplonk_prover* prover, size_t len);

/**
 * @brief Commits to a polynomial using the prover.
 *
 * Unlike \ref tachyon_halo2_bn254_shplonk_prover_commit(), this function
 * doesn't generate a commitment immediately to avoid expensive inverse
 * operations.
 *
 * @param prover A pointer to the prover.
 ...
 */
TACHYON_C_EXPORT void tachyon_halo2_bn254_shplonk_prover_batch_commit(
    tachyon_halo2_bn254_shplonk_prover* prover,
 ...
 *
 * Unlike \ref tachyon_halo2_bn254_shplonk_prover_commit_lagrange(),
 ...
 * @param idx The index of the commitment.
 */
TACHYON_C_EXPORT void tachyon_halo2_bn254_shplonk_prover_batch_commit_lagrange(
    tachyon_halo2_bn254_shplonk_prover* prover,
 ...
 * @param len The number of commitments.
 */
TACHYON_C_EXPORT void tachyon_halo2_bn254_shplonk_prover_batch_end(
