...
struct AddResult {
  ...
  bool operator==(const AddResult& other) const {
    return result == other.result && carry == other.carry;
  }
  bool operator!=(const AddResult& other) const { return !operator==(other); }
...
struct SubResult {
  ...
  bool operator==(const SubResult& other) const {
    return result == other.result && borrow == other.borrow;
  }
  bool operator!=(const SubResult& other) const { return !operator==(other); }
...
struct MulResult {
  ...
  bool operator==(const MulResult& other) const {
    return hi == other.hi && lo == other.lo;
  }
  bool operator!=(const MulResult& other) const { return !operator==(other); }
...
struct DivResult {
  ...
  bool operator==(const DivResult& other) const {
    return quotient == other.quotient && remainder == other.remainder;
  }
  bool operator!=(const DivResult& other) const { return !operator==(other); }
