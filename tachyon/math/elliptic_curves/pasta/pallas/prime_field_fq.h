#ifndef TACHYON_MATH_ELLIPTIC_CURVES_PASTA_PALLAS_PRIME_FIELD_FQ_H_
#define TACHYON_MATH_ELLIPTIC_CURVES_PASTA_PALLAS_PRIME_FIELD_FQ_H_
...
extern "C" void Fq_rawAdd(uint64_t result[4], const uint64_t a[4],
                          const uint64_t b[4]);
extern "C" void Fq_rawSub(uint64_t result[4], const uint64_t a[4],
                          const uint64_t b[4]);
extern "C" void Fq_rawNeg(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fq_rawMMul(uint64_t result[4], const uint64_t a[4],
                           const uint64_t b[4]);
extern "C" void Fq_rawMSquare(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fq_rawMMul1(uint64_t result[4], const uint64_t a[4],
                            uint64_t b);
extern "C" void Fq_rawToMontgomery(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fq_rawFromMontgomery(uint64_t result[4], const uint64_t a[4]);
extern "C" int Fq_rawIsEq(const uint64_t a[4], const uint64_t b[4]);
extern "C" int Fq_rawIsZero(const uint64_t v[4]);
...
class PrimeField<_Config, std::enable_if_t<_Config::kIsPallasFq>> final
 ...
 public:
  ...
  constexpr explicit PrimeField(const BigInt<N>& value) {
    ...
    Fq_rawToMontgomery(value_.limbs, value.limbs);
  }
  ...
  constexpr BigInt<N> ToBigInt() const {
    BigInt<N> ret;
    Fq_rawFromMontgomery(ret.limbs, value_.limbs);
    return ret;
  }
  ...
  constexpr bool operator==(const PrimeField& other) const {
    return Fq_rawIsEq(value_.limbs, other.value_.limbs);
  }
  ...
  constexpr PrimeField& AddInPlace(const PrimeField& other) {
    PrimeField ret;
    Fq_rawAdd(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& SubInPlace(const PrimeField& other) {
    PrimeField ret;
    Fq_rawSub(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& NegInPlace() {
    PrimeField ret;
    Fq_rawNeg(ret.value_.limbs, value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& MulInPlace(const PrimeField& other) {
    PrimeField ret;
    Fq_rawMMul(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& SquareInPlace() {
    PrimeField ret;
    Fq_rawMSquare(ret.value_.limbs, value_.limbs);
    *this = ret;
    return *this;
  }
...
#endif  // TACHYON_MATH_ELLIPTIC_CURVES_PASTA_PALLAS_PRIME_FIELD_FQ_H_
