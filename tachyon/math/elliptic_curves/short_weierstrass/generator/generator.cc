...
int GenerationConfig::GenerateConfigCudaHdr() const {
  std::string_view tpl[] = {
      ...
      "#define %{header_guard_macro}",
      "",
      "#include \"%{header_dir_name}/fq_cuda.cu.h\"",
      "#include \"%{header_dir_name}/fr_cuda.cu.h\"",
      "#include \"%{header_path}\"",
      ...
      "",
      "#if TACHYON_CUDA",
      "using %{class}AffinePointCuda = AffinePoint<SWCurveCuda<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}ProjectivePointCuda = ProjectivePoint<SWCurveCuda<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}JacobianPointCuda = JacobianPoint<SWCurveCuda<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}PointXYZZCuda = PointXYZZ<SWCurveCuda<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "#endif  // TACHYON_CUDA",
      "",
      "}  // namespace %{namespace}",
      "",
