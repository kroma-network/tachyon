...
int GenerationConfig::GenerateConfigGpuHdr() const {
  std::string_view tpl[] = {
      ...
      "namespace %{namespace} {",
      "",
      "using %{class}AffinePointGpu = AffinePoint<SWCurveGpu<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}ProjectivePointGpu = ProjectivePoint<SWCurveGpu<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}JacobianPointGpu = JacobianPoint<SWCurveGpu<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}PointXYZZGpu = PointXYZZ<SWCurveGpu<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "",
      "}  // namespace %{namespace}",
      "",
      "#endif  // %{header_guard_macro}",
