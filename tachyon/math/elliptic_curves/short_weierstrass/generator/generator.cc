...
int GenerationConfig::GenerateConfigCudaHdr() const {
  std::string_view tpl[] = {
      ...
      "",
      "#if TACHYON_CUDA",
      "using %{class}AffinePointCuda = AffinePoint<SWCurveGpu<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}ProjectivePointCuda = ProjectivePoint<SWCurveGpu<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}JacobianPointCuda = JacobianPoint<SWCurveGpu<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "using %{class}PointXYZZCuda = PointXYZZ<SWCurveGpu<%{class}CurveConfig<FqCuda, FrCuda>>>;",
      "#endif  // TACHYON_CUDA",
      "",
      "}  // namespace %{namespace}",
      "",
