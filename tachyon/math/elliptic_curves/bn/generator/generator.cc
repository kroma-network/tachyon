...
int GenerationConfig::GenerateConfigHdr() const {
  std::vector<std::string_view> tpl = {
      ...
      "    using BasePrimeField = FqTy;",
      "%{twist_mul_by_q_x_init}",
      "%{twist_mul_by_q_y_init}",
      "  }",
      "};",
      "",
      "template <typename FqTy, typename Fq2Ty, typename Fq6Ty, typename Fq12Ty, typename G1Curve, typename G2Curve>",
      "Fq2Ty %{class}Config<FqTy, Fq2Ty, Fq6Ty, Fq12Ty, G1Curve, G2Curve>::kTwistMulByQX;",
      "template <typename FqTy, typename Fq2Ty, typename Fq6Ty, typename Fq12Ty, typename G1Curve, typename G2Curve>",
      "Fq2Ty %{class}Config<FqTy, Fq2Ty, Fq6Ty, Fq12Ty, G1Curve, G2Curve>::kTwistMulByQY;",
      "",
