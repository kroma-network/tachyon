#ifndef TACHYON_MATH_ELLIPTIC_CURVES_SECP_SECP256K1_PRIME_FIELD_FR_H_
#define TACHYON_MATH_ELLIPTIC_CURVES_SECP_SECP256K1_PRIME_FIELD_FR_H_
...
extern "C" void Fnec_rawAdd(uint64_t result[4], const uint64_t a[4],
                            const uint64_t b[4]);
extern "C" void Fnec_rawSub(uint64_t result[4], const uint64_t a[4],
                            const uint64_t b[4]);
extern "C" void Fnec_rawNeg(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fnec_rawMMul(uint64_t result[4], const uint64_t a[4],
                             const uint64_t b[4]);
extern "C" void Fnec_rawMSquare(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fnec_rawMMul1(uint64_t result[4], const uint64_t a[4],
                              uint64_t b);
extern "C" void Fnec_rawToMontgomery(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fnec_rawFromMontgomery(uint64_t result[4], const uint64_t a[4]);
extern "C" int Fnec_rawIsEq(const uint64_t a[4], const uint64_t b[4]);
extern "C" int Fnec_rawIsZero(const uint64_t v[4]);
...
class PrimeField<_Config, std::enable_if_t<_Config::kIsSecp256k1Fr>> final
 ...
 public:
  ...
  constexpr explicit PrimeField(const BigInt<N>& value) {
    ...
    Fnec_rawToMontgomery(value_.limbs, value.limbs);
  }
  ...
  constexpr BigInt<N> ToBigInt() const {
    BigInt<N> ret;
    Fnec_rawFromMontgomery(ret.limbs, value_.limbs);
    return ret;
  }
  ...
  constexpr bool operator==(const PrimeField& other) const {
    return Fnec_rawIsEq(value_.limbs, other.value_.limbs);
  }
  ...
  constexpr PrimeField& AddInPlace(const PrimeField& other) {
    PrimeField ret;
    Fnec_rawAdd(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& SubInPlace(const PrimeField& other) {
    PrimeField ret;
    Fnec_rawSub(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& NegInPlace() {
    PrimeField ret;
    Fnec_rawNeg(ret.value_.limbs, value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& MulInPlace(const PrimeField& other) {
    PrimeField ret;
    Fnec_rawMMul(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& SquareInPlace() {
    PrimeField ret;
    Fnec_rawMSquare(ret.value_.limbs, value_.limbs);
    *this = ret;
    return *this;
  }
...
#endif  // TACHYON_MATH_ELLIPTIC_CURVES_SECP_SECP256K1_PRIME_FIELD_FR_H_
