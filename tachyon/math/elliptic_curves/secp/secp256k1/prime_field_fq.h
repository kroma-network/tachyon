#ifndef TACHYON_MATH_ELLIPTIC_CURVES_SECP_SECP256K1_PRIME_FIELD_FQ_H_
#define TACHYON_MATH_ELLIPTIC_CURVES_SECP_SECP256K1_PRIME_FIELD_FQ_H_
...
extern "C" void Fec_rawAdd(uint64_t result[4], const uint64_t a[4],
                           const uint64_t b[4]);
extern "C" void Fec_rawSub(uint64_t result[4], const uint64_t a[4],
                           const uint64_t b[4]);
extern "C" void Fec_rawNeg(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fec_rawMMul(uint64_t result[4], const uint64_t a[4],
                            const uint64_t b[4]);
extern "C" void Fec_rawMSquare(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fec_rawMMul1(uint64_t result[4], const uint64_t a[4],
                             uint64_t b);
extern "C" void Fec_rawToMontgomery(uint64_t result[4], const uint64_t a[4]);
extern "C" void Fec_rawFromMontgomery(uint64_t result[4], const uint64_t a[4]);
extern "C" int Fec_rawIsEq(const uint64_t a[4], const uint64_t b[4]);
extern "C" int Fec_rawIsZero(const uint64_t v[4]);
...
class PrimeField<_Config, std::enable_if_t<_Config::kIsSecp256k1Fq>> final
 ...
 public:
  ...
  constexpr explicit PrimeField(const BigInt<N>& value) {
    ...
    Fec_rawToMontgomery(value_.limbs, value.limbs);
  }
  ...
  constexpr BigInt<N> ToBigInt() const {
    BigInt<N> ret;
    Fec_rawFromMontgomery(ret.limbs, value_.limbs);
    return ret;
  }
  ...
  constexpr bool operator==(const PrimeField& other) const {
    return Fec_rawIsEq(value_.limbs, other.value_.limbs);
  }
  ...
  constexpr PrimeField& AddInPlace(const PrimeField& other) {
    PrimeField ret;
    Fec_rawAdd(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& SubInPlace(const PrimeField& other) {
    PrimeField ret;
    Fec_rawSub(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& NegInPlace() {
    PrimeField ret;
    Fec_rawNeg(ret.value_.limbs, value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& MulInPlace(const PrimeField& other) {
    PrimeField ret;
    Fec_rawMMul(ret.value_.limbs, value_.limbs, other.value_.limbs);
    *this = ret;
    return *this;
  }
  ...
  constexpr PrimeField& SquareInPlace() {
    PrimeField ret;
    Fec_rawMSquare(ret.value_.limbs, value_.limbs);
    *this = ret;
    return *this;
  }
...
#endif  // TACHYON_MATH_ELLIPTIC_CURVES_SECP_SECP256K1_PRIME_FIELD_FQ_H_
