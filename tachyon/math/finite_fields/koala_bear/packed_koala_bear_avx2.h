...
#ifndef TACHYON_MATH_FINITE_FIELDS_KOALA_BEAR_PACKED_KOALA_BEAR_AVX2_H_
#define TACHYON_MATH_FINITE_FIELDS_KOALA_BEAR_PACKED_KOALA_BEAR_AVX2_H_
...
class PackedKoalaBearAVX2 : public PackedPrimeFieldBase<PackedKoalaBearAVX2> {
 public:
  using PrimeField = KoalaBear;
...
#endif  //  TACHYON_MATH_FINITE_FIELDS_KOALA_BEAR_PACKED_KOALA_BEAR_AVX2_H_
